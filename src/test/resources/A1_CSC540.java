...
public class A1_CSC540 {
    ...
    void getChar() {
        ...
        if (inputLineIndex < inputLine.length()) {
            nextChar = inputLine.charAt(inputLineIndex);

            if (Character.getType(nextChar) == Character.LOWERCASE_LETTER) {
                charClass = CharClass.LETTER;
            }

            else if (Character.getType(nextChar) == Character.DECIMAL_DIGIT_NUMBER ||
                    nextChar == '.') {
    ...
    TokenCode lex() {
        ...
        switch(charClass) {
            ...
            case DIGIT -> {
                ...
                if (nextChar == '.') reportError();	 // handle case 1
                int decimalCount = 0;
                ...
                if (nextChar == '.') reportError();  // handle case 2
