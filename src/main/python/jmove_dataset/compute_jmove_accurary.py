...
recall_method_and_class_2 = len([i for i in oracle_points if
                                 i['recall_method_position'] in [0, 1] and i['recall_method_class_position'] == 0]) / len(oracle_points)
...
recall_method_and_class_3 = len([i for i in oracle_points if
                                 i['recall_method_position'] in [0, 1, 2] and i['recall_method_class_position'] == 0]) / len(oracle_points)
...
recall_method_and_class_all = len([i for i in oracle_points if
                                 i['recall_method_position']!=-1 and i['recall_method_class_position'] !=-1]) / len(oracle_points)
